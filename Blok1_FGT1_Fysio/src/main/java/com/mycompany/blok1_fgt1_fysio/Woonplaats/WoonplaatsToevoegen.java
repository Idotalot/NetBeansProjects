    ...
    public WoonplaatsToevoegen(GridPane pane)
    {
        ...
        toevoegKnop.setOnAction(event -> {
            try {
                ...
                String query = "INSERT INTO woonplaatsen (Naam) VALUES ('"+naamVeld.getText()+"')";
                ...
                if (rowsInserted > 0) {
                    System.out.println("A new woonplaats was inserted successfully!");
